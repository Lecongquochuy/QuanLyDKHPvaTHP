...
{
    public partial class fAddSubjectOfAddRegister : Form
    {
        public DataTable SubjectTable = new DataTable();

        private fAddRegister fARegister;
        public bool check = true;
        private string maHKNH;
        public fAddSubjectOfAddRegister(fAddRegister check, string MaHKNH)
        {
            InitializeComponent();
        ...
        private void btn_AddSub_Click(object sender, EventArgs e)
        {
            ...
            {
                bool exists = fARegister.CheckIfExists(SubjectIDValue);
        ...
        private void fAddSubjectOfAddRegister_FormClosed(object sender, FormClosedEventArgs e)
        {
            check = false;
        }
    }
