...
namespace QuanLyDKHPvaTHP
{
    partial class fDistrict
    {
        ...
        private void InitializeComponent()
        {
            ...
            DistrictId = new DataGridViewTextBoxColumn();
            DistrictName = new DataGridViewTextBoxColumn();
            ProvinceName = new DataGridViewTextBoxColumn();
            RemoteArea = new DataGridViewTextBoxColumn();
            ...
            pSearchBar.Margin = new Padding(4, 4, 4, 4);
            ...
            picSearch.Margin = new Padding(4, 4, 4, 4);
            ...
            btnAdd.Margin = new Padding(8, 8, 8, 8);
            btnAdd.Name = "btnAdd";
            ...
            dataGridView1.Columns.AddRange(new DataGridViewColumn[] { Number, DistrictId, DistrictName, ProvinceName, RemoteArea, Update, Delete });
            ...
            dataGridView1.Size = new Size(1400, 674);
            ...
            // DistrictId
            // 
            DistrictId.AutoSizeMode = DataGridViewAutoSizeColumnMode.Fill;
            DistrictId.DataPropertyName = "MaHuyen";
            DistrictId.HeaderText = "Mã huyện";
            DistrictId.MinimumWidth = 6;
            DistrictId.Name = "DistrictId";
            // 
            // DistrictName
            // 
            DistrictName.AutoSizeMode = DataGridViewAutoSizeColumnMode.Fill;
            DistrictName.DataPropertyName = "TenHuyen";
            DistrictName.HeaderText = "Tên huyện";
            DistrictName.MinimumWidth = 6;
            DistrictName.Name = "DistrictName";
            // 
            // ProvinceName
            // 
            ProvinceName.AutoSizeMode = DataGridViewAutoSizeColumnMode.Fill;
            ProvinceName.DataPropertyName = "TenTinh";
            ProvinceName.HeaderText = "Tên tỉnh";
            ProvinceName.MinimumWidth = 6;
            ProvinceName.Name = "ProvinceName";
            // 
            // RemoteArea
            // 
            RemoteArea.DataPropertyName = "VungSauVungXa";
            RemoteArea.HeaderText = "Vùng sâu vùng xa";
            RemoteArea.MinimumWidth = 6;
            RemoteArea.Name = "RemoteArea";
            RemoteArea.Width = 300;
            // 
            // Update
            // 
            Update.HeaderText = "";
        ...
        private DataGridViewTextBoxColumn DistrictId;
        private DataGridViewTextBoxColumn DistrictName;
        private DataGridViewTextBoxColumn ProvinceName;
        private DataGridViewTextBoxColumn RemoteArea;
